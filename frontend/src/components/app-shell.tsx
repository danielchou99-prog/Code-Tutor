...
function AppContent() {
  ...
  return (
    <main data-code-tutor-theme={settings.theme} className={`flex min-h-screen w-full min-w-0 max-w-full flex-col overflow-x-hidden text-slate-200 ${settings.theme === "light" ? settings.background === "grid" ? "bg-[#f4f7fb] bg-[linear-gradient(rgba(15,23,42,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(15,23,42,0.04)_1px,transparent_1px)] bg-[size:42px_42px]" : settings.background === "soft" ? "bg-[#f4f7fb] bg-[radial-gradient(circle_at_70%_20%,rgba(6,182,212,0.12),transparent_32%)]" : "bg-[#f4f7fb]" : settings.background === "grid" ? "bg-[#090d14] bg-[linear-gradient(rgba(255,255,255,0.018)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.018)_1px,transparent_1px)] bg-[size:42px_42px]" : settings.background === "soft" ? "bg-[#090d14] bg-[radial-gradient(circle_at_70%_20%,rgba(34,211,238,0.07),transparent_32%)]" : "bg-[#090d14]"}`}>
      <SiteHeader
